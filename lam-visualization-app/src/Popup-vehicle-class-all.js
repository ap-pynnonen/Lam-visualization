...
const CustomPopup = (props) => {
    ...
    const Handleddata = [["Nopeus", "Suunta 1 KAIP", { role: "style" }, "Suunta 2 KAIP", { role: "style" }, "Suunta 1 Linja-autot", { role: "style" }, "Suunta 2 Linja-autot", { role: "style" }, "Suunta 1 KAPP", { role: "style" }, "Suunta 2 KAPP", { role: "style" }, "Suunta 1 KATP", { role: "style" }, "Suunta 2 KATP", { role: "style" }, "Suunta 1 HA+PK", { role: "style" }, "Suunta 2 HA+PK", { role: "style" }, "Suunta 1 HA+AV", { role: "style" }, "Suunta 2 HA+AV", { role: "style" }, "Suunta 1 MP", { role: "style" }, "Suunta 2 MP", { role: "style" }, "Suunta 1 HCT", { role: "style" }, "Suunta 2 HCT", { role: "style" },]]; //array for parsed csv data with header row set
...
const speed2020 = [306, 582, 597];
    ...
    function DataHandle1 (Data) { //Handle 1 Day csv data
      ...
      for (let k = 0;k < 195;k++) {
        ...
        for(let i = 0; i < Data.data.length; i++) {
          if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 2) {
            counter++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 2) {
            counter2++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 3) {
            counter3++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 3) {
            counter4++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 4) {
            counter5++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 4) {
            counter6++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 5) {
            counter7++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 5) {
            counter8++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 6) {
            counter9++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 6) {
            counter10++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 7) {
            counter11++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 7) {
            counter12++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 8) {
            counter13++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 8) {
            counter14++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 1 && Data.data[i][12] == 0 && Data.data[i][10] == 9) {
            counter15++;
          }
          else if (speedcounter == Data.data[i][11] && Data.data[i][9] == 2 && Data.data[i][12] == 0 && Data.data[i][10] == 9) {
            counter16++;
          }
        }
       ...
       Handleddata.push([newspeed, counter, color, counter2, color2, counter3, color, counter4, color2, counter5, color, counter6, color2, counter7, color, counter8, color2, counter9, color, counter10, color2, counter11, color, counter12, color2, counter13, color, counter14, color2, counter15, color, counter16, color2]); //add new speed, car amount and color
       speedcounter++;
      }
    ...
    function DataHandlemulti (Data, num) { //handle multiple days csv data
      ...
      for (let k = 0;k < 195;k++) {
       ...
       Handleddata2.push([newspeed, counter, color, counter2, color2, counter3, color, counter4, color2, counter5, color, counter6, color2, counter7, color, counter8, color2, counter9, color, counter10, color2, counter11, color, counter12, color2, counter13, color, counter14, color2, counter15, color, counter16, color2]); //add new speed, car amount and color
       speedcounter++;
      }
    ...
    function compileData(dat1, dat2, dat3) { //Add together 3 days certain speed time of day selected from day select
      ...
      for (let i = 1; i< 196; i++) { //get speed time of day to chart day 3
        ...
        counter3 = tempdata1[i][5] + tempdata2[i][5] + tempdata3[i][5];
        counter4 = tempdata1[i][7] + tempdata2[i][7] + tempdata3[i][7];
        counter5 = tempdata1[i][9] + tempdata2[i][9] + tempdata3[i][9];
        counter6 = tempdata1[i][11] + tempdata2[i][11] + tempdata3[i][11];
        counter7 = tempdata1[i][13] + tempdata2[i][13] + tempdata3[i][13];
        counter8 = tempdata1[i][15] + tempdata2[i][15] + tempdata3[i][15];
        counter9 = tempdata1[i][17] + tempdata2[i][17] + tempdata3[i][17];
        counter10 = tempdata1[i][19] + tempdata2[i][19] + tempdata3[i][19];
        counter11 = tempdata1[i][21] + tempdata2[i][21] + tempdata3[i][21];
        counter12 = tempdata1[i][23] + tempdata2[i][23] + tempdata3[i][23];
        counter13 = tempdata1[i][25] + tempdata2[i][25] + tempdata3[i][25];
        counter14 = tempdata1[i][27] + tempdata2[i][27] + tempdata3[i][27];
        counter15 = tempdata1[i][29] + tempdata2[i][29] + tempdata3[i][29];
        counter16 = tempdata1[i][31] + tempdata2[i][31] + tempdata3[i][31];
        Handleddata.push([speed, counter, color, counter2, color2, counter3, color, counter4, color2, counter5, color, counter6, color2, counter7, color, counter8, color2, counter9, color, counter10, color2, counter11, color, counter12, color2, counter13, color, counter14, color2, counter15, color, counter16, color2]);
      }
      props.setdata(Handleddata);
      props.setoriginal(Handleddata);
        ...
        for (let i = 1; i< 196; i++) { //get speed time of day to chart day 3
          ...
          counter3 = props.data1[i][5] + props.data2[i][5] + props.data3[i][5];
          counter4 = props.data1[i][7] + props.data2[i][7] + props.data3[i][7];
          counter5 = props.data1[i][9] + props.data2[i][9] + props.data3[i][9];
          counter6 = props.data1[i][11] + props.data2[i][11] + props.data3[i][11];
          counter7 = props.data1[i][13] + props.data2[i][13] + props.data3[i][13];
          counter8 = props.data1[i][15] + props.data2[i][15] + props.data3[i][15];
          counter9 = props.data1[i][17] + props.data2[i][17] + props.data3[i][17];
          counter10 = props.data1[i][19] + props.data2[i][19] + props.data3[i][19];
          counter11 = props.data1[i][21] + props.data2[i][21] + props.data3[i][21];
          counter12 = props.data1[i][23] + props.data2[i][23] + props.data3[i][23];
          counter13 = props.data1[i][25] + props.data2[i][25] + props.data3[i][25];
          counter14 = props.data1[i][27] + props.data2[i][27] + props.data3[i][27];
          counter15 = props.data1[i][29] + props.data2[i][29] + props.data3[i][29];
          counter16 = props.data1[i][31] + props.data2[i][31] + props.data3[i][31];
          Handleddata.push([speed, counter, color, counter2, color2, counter3, color, counter4, color2, counter5, color, counter6, color2, counter7, color, counter8, color2, counter9, color, counter10, color2, counter11, color, counter12, color2, counter13, color, counter14, color2, counter15, color, counter16, color2]);
        }
        props.setdata(Handleddata);
        props.setoriginal(Handleddata);
    ...
    function compileData2(dat1, dat2, dat3, dat4, dat5, dat6, dat7) { //Add together 7 days certain speed time of day selected from day select
      ...
      for (let i = 1; i< 196; i++) { //get speed time of day to chart day 7
        ...
        color2 = tempdata1[i][4];
        counter3 = tempdata1[i][5] + tempdata2[i][5] + tempdata3[i][5] + tempdata4[i][5] + tempdata5[i][5] + tempdata6[i][5] + tempdata7[i][5];
        counter4 = tempdata1[i][7] + tempdata2[i][7] + tempdata3[i][7] + tempdata4[i][7] + tempdata5[i][7] + tempdata6[i][7] + tempdata7[i][7];
        counter5 = tempdata1[i][9] + tempdata2[i][9] + tempdata3[i][9] + tempdata4[i][9] + tempdata5[i][9] + tempdata6[i][9] + tempdata7[i][9];
        counter6 = tempdata1[i][11] + tempdata2[i][11] + tempdata3[i][11] + tempdata4[i][11] + tempdata5[i][11] + tempdata6[i][11] + tempdata7[i][11];
        counter7 = tempdata1[i][13] + tempdata2[i][13] + tempdata3[i][13] + tempdata4[i][13] + tempdata5[i][13] + tempdata6[i][13] + tempdata7[i][13];
        counter8 = tempdata1[i][15] + tempdata2[i][15] + tempdata3[i][15] + tempdata4[i][15] + tempdata5[i][15] + tempdata6[i][15] + tempdata7[i][15];
        counter9 = tempdata1[i][17] + tempdata2[i][17] + tempdata3[i][17] + tempdata4[i][17] + tempdata5[i][17] + tempdata6[i][17] + tempdata7[i][17];
        counter10 = tempdata1[i][19] + tempdata2[i][19] + tempdata3[i][19] + tempdata4[i][19] + tempdata5[i][19] + tempdata6[i][19] + tempdata7[i][19];
        counter11 = tempdata1[i][21] + tempdata2[i][21] + tempdata3[i][21] + tempdata4[i][21] + tempdata5[i][21] + tempdata6[i][21] + tempdata7[i][21];
        counter12 = tempdata1[i][23] + tempdata2[i][23] + tempdata3[i][23] + tempdata4[i][23] + tempdata5[i][23] + tempdata6[i][23] + tempdata7[i][23];
        counter13 = tempdata1[i][25] + tempdata2[i][25] + tempdata3[i][25] + tempdata4[i][25] + tempdata5[i][25] + tempdata6[i][25] + tempdata7[i][25];
        counter14 = tempdata1[i][27] + tempdata2[i][27] + tempdata3[i][27] + tempdata4[i][27] + tempdata5[i][27] + tempdata6[i][27] + tempdata7[i][27];
        counter15 = tempdata1[i][29] + tempdata2[i][29] + tempdata3[i][29] + tempdata4[i][29] + tempdata5[i][29] + tempdata6[i][29] + tempdata7[i][29];
        counter16 = tempdata1[i][31] + tempdata2[i][31] + tempdata3[i][31] + tempdata4[i][31] + tempdata5[i][31] + tempdata6[i][31] + tempdata7[i][31];
        Handleddata.push([speed, counter, color, counter2, color2, counter3, color, counter4, color2, counter5, color, counter6, color2, counter7, color, counter8, color2, counter9, color, counter10, color2, counter11, color, counter12, color2, counter13, color, counter14, color2, counter15, color, counter16, color2]);
      }
      props.setdata(Handleddata);
      props.setoriginal(Handleddata);
        ...
        for (let i = 1; i< 196; i++) { //get speed time of day to chart day 7
          ...
          color2 = props.data1[i][4];
          counter3 = props.data1[i][5] + props.data2[i][5] + props.data3[i][5] + props.data4[i][5] + props.data5[i][5] + props.data6[i][5] + props.data7[i][5];
          counter4 = props.data1[i][7] + props.data2[i][7] + props.data3[i][7] + props.data4[i][7] + props.data5[i][7] + props.data6[i][7] + props.data7[i][7];
          counter5 = props.data1[i][9] + props.data2[i][9] + props.data3[i][9] + props.data4[i][9] + props.data5[i][9] + props.data6[i][9] + props.data7[i][9];
          counter6 = props.data1[i][11] + props.data2[i][11] + props.data3[i][11] + props.data4[i][11] + props.data5[i][11] + props.data6[i][11] + props.data7[i][11];
          counter7 = props.data1[i][13] + props.data2[i][13] + props.data3[i][13] + props.data4[i][13] + props.data5[i][13] + props.data6[i][13] + props.data7[i][13];
          counter8 = props.data1[i][15] + props.data2[i][15] + props.data3[i][15] + props.data4[i][15] + props.data5[i][15] + props.data6[i][15] + props.data7[i][15];
          counter9 = props.data1[i][17] + props.data2[i][17] + props.data3[i][17] + props.data4[i][17] + props.data5[i][17] + props.data6[i][17] + props.data7[i][17];
          counter10 = props.data1[i][19] + props.data2[i][19] + props.data3[i][19] + props.data4[i][19] + props.data5[i][19] + props.data6[i][19] + props.data7[i][19];
          counter11 = props.data1[i][21] + props.data2[i][21] + props.data3[i][21] + props.data4[i][21] + props.data5[i][21] + props.data6[i][21] + props.data7[i][21];
          counter12 = props.data1[i][23] + props.data2[i][23] + props.data3[i][23] + props.data4[i][23] + props.data5[i][23] + props.data6[i][23] + props.data7[i][23];
          counter13 = props.data1[i][25] + props.data2[i][25] + props.data3[i][25] + props.data4[i][25] + props.data5[i][25] + props.data6[i][25] + props.data7[i][25];
          counter14 = props.data1[i][27] + props.data2[i][27] + props.data3[i][27] + props.data4[i][27] + props.data5[i][27] + props.data6[i][27] + props.data7[i][27];
          counter15 = props.data1[i][29] + props.data2[i][29] + props.data3[i][29] + props.data4[i][29] + props.data5[i][29] + props.data6[i][29] + props.data7[i][29];
          counter16 = props.data1[i][31] + props.data2[i][31] + props.data3[i][31] + props.data4[i][31] + props.data5[i][31] + props.data6[i][31] + props.data7[i][31];
          Handleddata.push([speed, counter, color, counter2, color2, counter3, color, counter4, color2, counter5, color, counter6, color2, counter7, color, counter8, color2, counter9, color, counter10, color2, counter11, color, counter12, color2, counter13, color, counter14, color2, counter15, color, counter16, color2]);
        }
        props.setdata(Handleddata);
        props.setoriginal(Handleddata);
    ...
    function changechartdata(row) { // day 1 change chart data
        ...
        for(let i = 0;i < props.data1original.data.length; i++) { //get speed time of day to chart day 1
            if (listspeed == props.data1original.data[i][11] && props.data1original.data[i][12] == 0) {
                ...
                textlist.push([props.datapoint, props.title, props.data1original.data[i][9], time, speed, props.data1original.data[i][10]]);
            }
        }
    ...
    function changechartdatamulti(row) { //day 3 change chart data
      ...
      for(let i = 0;i < props.data2original.data.length; i++) {
        if (listspeed == props.data2original.data[i][11] && props.data2original.data[i][12] == 0) {
            ...
            Handleddatatime.push([time, speed, color]);
            textlist.push([props.datapoint, props.title, props.data2original.data[i][9], time, speed, props.data2original.data[i][10]]);
        }
    }
    ...
    for(let i = 0;i < props.data3original.data.length; i++) {
      if (listspeed == props.data3original.data[i][11] && props.data3original.data[i][12] == 0) {
          ...
          Handleddatatime.push([time, speed, color]);
          textlist.push([props.datapoint, props.title, props.data3original.data[i][9], time, speed, props.data3original.data[i][10]]);
      }
  }
  ...
  for(let i = 0;i < props.data4original.data.length; i++) {
    if (listspeed == props.data4original.data[i][11] && props.data4original.data[i][12] == 0) {
        ...
        Handleddatatime.push([time, speed, color]);
        textlist.push([props.datapoint, props.title, props.data4original.data[i][9], time, speed, props.data4original.data[i][10]]);
    }
  }
  ...
  for(let i = 0;i < props.data5original.data.length; i++) {
    if (listspeed == props.data5original.data[i][11] && props.data5original.data[i][12] == 0) {
        ...
        Handleddatatime.push([time, speed, color]);
        textlist.push([props.datapoint, props.title, props.data5original.data[i][9], time, speed, props.data5original.data[i][10]]);
    }
  }
  ...
  for(let i = 0;i < props.data6original.data.length; i++) {
    if (listspeed == props.data6original.data[i][11] && props.data6original.data[i][12] == 0) {
        ...
        Handleddatatime.push([time, speed, color]);
        textlist.push([props.datapoint, props.title, props.data6original.data[i][9], time, speed, props.data6original.data[i][10]]);
    }
  }
  ...
  for(let i = 0;i < props.data7original.data.length; i++) {
    if (listspeed == props.data7original.data[i][11] && props.data7original.data[i][12] == 0) {
        ...
        Handleddatatime.push([time, speed, color]);
        textlist.push([props.datapoint, props.title, props.data7original.data[i][9], time, speed, props.data7original.data[i][10]]);
    }
  }
